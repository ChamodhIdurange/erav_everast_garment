...
else if($lastElement=='productreorder.php'){
...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <?php if(menucheck($menuprivilegearray, 9)==1 | menucheck($menuprivilegearray, 8)==1 | menucheck($menuprivilegearray, 69)==1 | menucheck($menuprivilegearray, 71)==1 | menucheck($menuprivilegearray, 72)==1 | menucheck($menuprivilegearray, 81)==1){ ?>
            ...
            <div class="collapse <?php if($lastElement=="product.php" | $lastElement=="productcategory.php" | $lastElement=="productfree.php" | $lastElement=="groupcategory.php" | $lastElement=="subproductcategory.php" | $lastElement=="productreorder.php"){echo 'show';} ?>" id="collapseproduct" data-parent="#accordionSidenav">
            ...
            <a class="nav-link p-0 px-3 py-2 collapsed" href="javascript:void(0);" data-toggle="collapse" data-target="#collapseelectricians" aria-expanded="false" aria-controls="collapseelectricians">
                <div class="nav-link-icon"><i data-feather="user-check"></i></div>
                Electrician
                <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
            </a>
            <div class="collapse <?php if($lastElement=="electricians.php" | $lastElement=="electricianbox.php" | $lastElement=="offer.php" | $lastElement=="selected.php"){echo 'show';} ?>" id="collapseelectricians" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
            ...
            <a class="nav-link p-0 px-3 py-2" href="productreturn.php">
            ...
            <?php } if(menucheck($menuprivilegearray, 79)==1 | menucheck($menuprivilegearray, 80)==1){ ?>
            ...
            <div class="collapse <?php if($lastElement=="freeissuetype.php" | $lastElement=="freeissue.php"){echo 'show';} ?>" id="collapsefreeissue" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
            ...
            <div class="collapse <?php if($lastElement=="vehicle.php" | $lastElement=="employee.php" | $lastElement=="area.php" | $lastElement=="expensestype.php"){echo 'show';} ?>" id="collapseother" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
