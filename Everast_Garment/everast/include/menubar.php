...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <?php }if(menucheck($menuprivilegearray, 75)==1 | menucheck($menuprivilegearray, 76)==1 | menucheck($menuprivilegearray, 77)==1 | menucheck($menuprivilegearray, 78)==1){ ?>
            ...
            <!-- Added by Chamodh -->
            <?php }if(menucheck($menuprivilegearray, 9)==1 | menucheck($menuprivilegearray, 8)==1 | menucheck($menuprivilegearray, 69)==1 | menucheck($menuprivilegearray, 97)==1 | menucheck($menuprivilegearray, 98)==1){ ?>
            <a class="nav-link p-0 px-3 py-2 collapsed" href="javascript:void(0);" data-toggle="collapse"
            ...
            <div class="collapse <?php if($lastElement=="product.php" | $lastElement=="productcategory.php" | $lastElement=="productfree.php" | $lastElement=="groupcategory.php" | $lastElement=="subproductcategory.php" | $lastElement=="sizematrix.php" | $lastElement=="sizecategories.php"){echo 'show';} ?>"
            ...
            <div class="collapse <?php if($lastElement=="materials.php" | $lastElement=="productmaterials.php" ){echo 'show';} ?>" id="materialcollapse"
            ...
            <!-- 2021/12/25 -->
            <?php } if(menucheck($menuprivilegearray, 42)==1 | menucheck($menuprivilegearray, 88)==1 | menucheck($menuprivilegearray, 89)==1 | menucheck($menuprivilegearray, 90)==1){ ?>
            <a class="nav-link p-0 px-3 py-2 collapsed" href="javascript:void(0);" data-toggle="collapse"
            ...
            <div class="collapse <?php if($lastElement=="freeissuetype.php" | $lastElement=="freeissue.php"){echo 'show';} ?>"
