...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <!-- Added by Chamodh -->
            <?php if(menucheck($menuprivilegearray, 9)==1 | menucheck($menuprivilegearray, 8)==1 | menucheck($menuprivilegearray, 69)==1){ ?>
            <a class="nav-link p-0 px-3 py-2 collapsed" href="javascript:void(0);" data-toggle="collapse"
            ...
            <div class="collapse <?php if($lastElement=="product.php" | $lastElement=="productcategory.php" | $lastElement=="productfree.php" | $lastElement=="groupcategory.php" | $lastElement=="subproductcategory.php"){echo 'show';} ?>"
            ...
            <div class="collapse <?php if($lastElement=="invoice.php" | $lastElement=="invoicepayment.php" | $lastElement=="paymentreceipt.php" | $lastElement=="invoiceview.php" | $lastElement=="invoicerecovery.php"){echo 'show';} ?>"
            ...
            <!-- 2021/12/25 -->
            <?php } if(menucheck($menuprivilegearray, 11)==1 | menucheck($menuprivilegearray, 12)==1 | menucheck($menuprivilegearray, 13)==1 | menucheck($menuprivilegearray, 70)==1){ ?>
            <a class="nav-link p-0 px-3 py-2 collapsed" href="javascript:void(0);" data-toggle="collapse"
                data-target="#collapsereturn" aria-expanded="false" aria-controls="collapsereturn">
                <div class="nav-link-icon"><i data-feather="corner-down-left"></i></div>
                Product Return
                <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
            </a>
            <div class="collapse <?php if($lastElement=="vehicle.php" | $lastElement=="employee.php" | $lastElement=="area.php" | $lastElement=="expensestype.php"){echo 'show';} ?>"
            ...
            <?php if(menucheck($menuprivilegearray, 11)==1 | menucheck($menuprivilegearray, 12)==1 | menucheck($menuprivilegearray, 13)==1 | menucheck($menuprivilegearray, 70)==1){ ?>
            <a class="nav-link p-0 px-3 py-2 collapsed" href="javascript:void(0);" data-toggle="collapse"
                data-target="#collapsefreeissue" aria-expanded="false" aria-controls="collapsefreeissue">
            ...
            <div class="collapse <?php if($lastElement=="employeetargetadd.php" | $lastElement=="vehicletargetadd.php"){echo 'show';} ?>"
            ...
            <div class="collapse <?php if($lastElement=="company.php" | $lastElement=="companybranch.php"){echo 'show';} ?>"
            ...
            <div class="collapse <?php if($lastElement=="bank-info.php" | $lastElement=="branch-info.php" | $lastElement=="chequeinfo.php" | $lastElement=="paymenttype.php"){echo 'show';} ?>"
            ...
            <div class="collapse <?php if($lastElement=="account-mainclass.php" | $lastElement=="account-subclass.php" | $lastElement=="account-mainaccount.php" | $lastElement=="account-subaccount.php"  | $lastElement=="accountcategory.php" | $lastElement=="financialyear.php" | $lastElement=="financialyearbranch.php" | $lastElement=="account-allocation.php" | $lastElement=="account-allocationtobankbranch.php" | $lastElement=="account-block.php" | $lastElement=="payment.php" | $lastElement=="receipt.php" | $lastElement=="dailypaymenttoaccount.php" | $lastElement=="bank_reconcile.php" | $lastElement=="deposit.php" | $lastElement=="paymenttoaccount.php" | $lastElement=="reverse_transaction.php" | $lastElement=="rpt_ledger_folio.php" | $lastElement=="rpt_trial_balance.php" | $lastElement=="pettycash.php" | $lastElement=="postpettycash.php" | $lastElement=="rpt_period_trial_balance.php" | $lastElement=="rpt_balance_sheet.php" | $lastElement=="rpt_profit_and_loss.php"  | $lastElement=="account_balance_update.php" | $lastElement=="pettycashreimbursement.php"){echo 'show';} ?>"
                ...
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <!-- Petty Cash -->
                    <a class="nav-link p-0 px-3 py-2 collapsed" href="#" data-toggle="collapse"
                        data-target="#accordionAccountPetty" aria-expanded="false"
                        aria-controls="accordionAccountPetty">
                        Petty Cash
                        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div></a>
                    <div class="collapse <?php if($lastElement=="pettycash.php" | $lastElement=="postpettycash.php" | $lastElement=="pettycashreimbursement.php"){echo 'show';} ?>"
                        id="accordionAccountPetty" data-parent="#accordionAccountPetty">
                        <nav class="sidenav-menu-nested nav">
                            ...
                            <a class="nav-link p-0 px-3 py-1" href="pettycashreimbursement.php">Petty Cash
                                Reimbursement</a>
                            <?php } ?>
                        </nav>
                    </div>
                    <!-- Master -->
                    <a class="nav-link p-0 px-3 py-2 collapsed" href="#" data-toggle="collapse"
                        data-target="#accordionSidenavLayout" aria-expanded="false"
                        aria-controls="accordionSidenavLayout">
                        Master
                        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div></a>
                    <div class="collapse <?php if($lastElement=="account-mainclass.php" | $lastElement=="account-subclass.php" | $lastElement=="account-mainaccount.php" | $lastElement=="account-subaccount.php"  | $lastElement=="accountcategory.php"  | $lastElement=="account_balance_update.php"){echo 'show';} ?>"
                        id="accordionSidenavLayout" data-parent="#accordionSidenavLayout">
                        <nav class="sidenav-menu-nested nav">
                    ...
                    <!-- Other -->
                    <a class="nav-link p-0 px-3 py-2 collapsed" href="#" data-toggle="collapse"
                        data-target="#accordionAccountOther" aria-expanded="false"
                        aria-controls="accordionAccountOther">
                        Other
                        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div></a>
                    <div class="collapse <?php if($lastElement=="financialyear.php" | $lastElement=="financialyearbranch.php" | $lastElement=="account-allocation.php" | $lastElement=="account-allocationtobankbranch.php" | $lastElement=="account-block.php"){echo 'show';} ?>"
                        id="accordionAccountOther" data-parent="#accordionAccountOther">
                        <nav class="sidenav-menu-nested nav">
                            ...
                            <a class="nav-link p-0 px-3 py-1" href="financialyearbranch.php">Financial Year
                                Allocation</a>
                            ...
                            <a class="nav-link p-0 px-3 py-1" href="account-allocationtobankbranch.php">Account To
                                Branch</a>
                    ...
                    <!-- Reports -->
                    <a class="nav-link p-0 px-3 py-2 collapsed" href="#" data-toggle="collapse"
                        data-target="#accordionAccountReports" aria-expanded="false"
                        aria-controls="accordionAccountReports">
                        Reports
                        <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div></a>
                    <div class="collapse <?php if($lastElement=="rpt_ledger_folio.php" | $lastElement=="rpt_trial_balance.php" | $lastElement=="rpt_period_trial_balance.php" | $lastElement=="rpt_balance_sheet.php" | $lastElement=="rpt_profit_and_loss.php"){echo 'show';} ?>"
                        id="accordionAccountReports" data-parent="#accordionAccountReports">
                        <nav class="sidenav-menu-nested nav">
                            <?php if(menucheck($menuprivilegearray, 57)==1){ ?>
                            ...
                            <a class="nav-link p-0 px-3 py-1" href="rpt_period_trial_balance.php">Period Trial
                                Balance</a>
