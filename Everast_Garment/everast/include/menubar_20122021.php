...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <div class="collapse <?php if($lastElement=="product.php" | $lastElement=="productcategory.php" | $lastElement=="productfree.php" | $lastElement=="groupcategory.php" | $lastElement=="subproductcategory.php"){echo 'show';} ?>" id="collapseproduct" data-parent="#accordionSidenav">
