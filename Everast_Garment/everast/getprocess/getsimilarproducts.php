...
$sql="SELECT * FROM `tbl_product` WHERE `status`=1 AND `tbl_product_category_idtbl_product_category` = '$categoryId' AND `tbl_group_category_idtbl_group_category` = '$groupCatId' AND `tbl_sub_product_category_idtbl_sub_product_category` = '$subCatId'";
