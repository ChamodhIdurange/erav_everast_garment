...
$sqlnotassign="SELECT `idtbl_customer`, `name` FROM `tbl_customer` WHERE `status` IN (1,2) AND `ref` = '0'";
...
<div class="row">
    <div class="col-12">
        ...
        <div class="row">
            <div class="col-md-6">
                <table class="table table-striped table-bordered table-sm" id="tableassignref">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Customer</th>
