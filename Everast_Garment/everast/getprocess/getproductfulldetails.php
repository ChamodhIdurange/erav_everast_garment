...
$sql="SELECT * FROM `tbl_product` AS `p` LEFT JOIN `tbl_product_category` AS `c` ON (`p`.`tbl_product_category_idtbl_product_category` = `c`.`idtbl_product_category`) WHERE `p`.`idtbl_product`='$record'";
