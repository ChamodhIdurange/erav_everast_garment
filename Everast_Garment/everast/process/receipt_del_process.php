...
$presql = "SELECT id FROM tbl_gl_receipts WHERE id=? AND receipt_complete=0";
...
if($flag){
	$updateSQL = "UPDATE tbl_gl_receipt_details SET receipt_cancel=1, updated_by=?, updated_at=NOW() WHERE id=? AND receipt_cancel=0";
