            ...
            <div class="modal-body">
                <div class="row">
                        ...
                        <form id="createorderform" autocomplete="off">
                            <div class="form-group mb-1">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control dpd1a" placeholder="" name="orderdate" id="orderdate" required>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select class="form-control form-control-sm" name="repname" id="repname" required>
                                    ...
                                    <?php if($resultreplist->num_rows > 0) {while ($rowreplist = $resultreplist-> fetch_assoc()) { ?>
                                    <option value="<?php echo $rowreplist['idtbl_employee'] ?>"><?php echo $rowreplist['name'] ?></option>
                                    <?php }} ?>
                                </select>
                            </div>
                            <div class="form-group mb-2">
                            ...
                            <div class="form-row mb-1">
                                <div class="col">
                                    ...
                                    <input type="number" id="discountpresentage" name="discountpresentage" class="form-control form-control-sm" value="25">
                                </div>
                            </div>
                            <div class="form-group mb-2">
                            ...
                            <div class="form-row mb-1">
                                <div class="col">
                                    ...
                                    <input type="text" id="saleprice" name="saleprice" class="form-control form-control-sm" value="0" readonly>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-9 col-xl-9">
                        ...
                        <div class="row">
                            <div class="col-9 text-right"><h6 class="">Subtotal</h6></div>
                            <div class="col text-right"><h6 class="" id="divsubtotal">Rs. 0.00</h6></div>
                            <input type="hidden" id="hidetotalorder" value="0">
                        </div>
                        <div class="row">
                            <div class="col-9 text-right"><h6 class="">Discount</h6></div>
                            <div class="col text-right"><h6 class="" id="divdiscount">Rs. 0.00</h6></div>
                            <input type="hidden" id="hidediscount" value="0">
                        </div>
                        <div class="row">
                            <div class="col-9 text-right"><h1 class="">Nettotal</h1></div>
                            <div class="col text-right"><h1 class="" id="divtotal">Rs. 0.00</h1></div>
                            <input type="hidden" id="hidenettotalorder" value="0">
                        </div>
                        <hr>
                        <div class="form-group">
                            <label class="small font-weight-bold text-dark">Payment option on delivery</label><br>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="paymentoption1" name="paymentoption" class="custom-control-input" value="0" checked>
                                <label class="custom-control-label" for="paymentoption1">Pay full amount</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="paymentoption2" name="paymentoption" class="custom-control-input" value="1">
                        ...
                        <div class="form-group mt-2">
                            <button type="button" id="btncreateorder" class="btn btn-outline-primary btn-sm fa-pull-right" <?php if($addcheck==0){echo 'disabled';} ?>><i class="fas fa-save"></i>&nbsp;Create Order</button>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-9 text-right"><h5 class="font-weight-600">Subtotal</h5></div>
                    <div class="col-3 text-right"><h5 class="font-weight-600" id="divsubtotalview">Subtotal: Rs. 0.00</h5></div>
                    <div class="col-9 text-right"><h5 class="font-weight-600">Discount</h5></div>
                    <div class="col-3 text-right"><h5 class="font-weight-600" id="divdiscountview">Rs. 0.00</h5></div>
                    <div class="col-9 text-right"><h1 class="font-weight-600">Nettotal</h1></div>
                    <div class="col-3 text-right"><h1 class="font-weight-600" id="divtotalview">Rs. 0.00</h1></div>
...
<script>
    $(document).ready(function() {
        ...
        $('#dataTable').DataTable( {
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        var button='';
                        button+='<button class="btn btn-outline-dark btn-sm btnview mr-1" id="'+full['idtbl_porder']+'"><i class="far fa-eye"></i></button>';
                        if(full['status']==2){
                            button+='<button class="btn btn-secondary btn-sm btnreactive mr-1" id="'+full['idtbl_porder']+'"><i class="fas fa-check"></i></button>';
                        }
                        if(full['status']==1){
                        ...
                        if(full['callstatus']==0 && full['status']==1){
                            button+='<button class="btn btn-success btn-sm btncall mr-1" id="'+full['idtbl_porder']+'"><i class="fas fa-phone"></i></button>';
                        }
                        ...
                        if(full['status']==1){
                            button+='<button class="btn btn-outline-secondary btn-sm btntracking mr-1" id="'+full['idtbl_porder']+'"><i class="fas fa-map-marker-alt"></i></button>'
                        }

                        if(full['confirmstatus']==0 && full['status']==1){button+='<button class="btn btn-outline-orange btn-sm btnaccept mr-1" data-toggle="tooltip" data-placement="bottom" title="Not Accept Order" id="'+full['idtbl_porder']+'"><i class="fas fa-times"></i></button>';}
                        else if(full['confirmstatus']==1 && full['status']==1){button+='<button class="btn btn-outline-success btn-sm mr-1" data-toggle="tooltip" data-placement="bottom" title="Accepted Order"><i class="fas fa-check"></i></button>';}

                        if(full['paystatus']==0 && full['status']==1){button+='<button class="btn btn-outline-danger btn-sm mr-1 btnpayment" id="'+full['idtbl_porder']+'"><i class="fas fa-money-bill-alt"></i></button>';}
                        else if(full['status']==1){button+='<button class="btn btn-outline-success btn-sm mr-1 btnpaydone" id="'+full['idtbl_porder']+'"><i class="fas fa-money-bill-alt"></i></button>';}
                        ...
                        if(full['deliverystatus']==0 && full['status']==1){button+='<button class="btn btn-outline-danger btn-sm mr-1 btndelivery" id="'+full['idtbl_porder']+'"><i class="fas fa-truck"></i></button>';}
                        else if(full['status']==1){button+='<button class="btn btn-outline-success btn-sm mr-1"><i class="fas fa-truck"></i></button>';}

                        if(full['deliverystatus']==0 && full['status']==1){button+='<button class="btn btn-outline-danger btn-sm mr-1 btncancel" id="'+full['idtbl_porder']+'"><i class="fas fa-window-close"></i></button><button class="btn btn-primary btn-sm btnreturn" id="'+full['idtbl_porder']+'"><i class="fas fa-redo-alt"></i></button>';}
                        return button;
                    }
                }
            ]
            ...
            $.ajax({
                ...
                success: function(result) { //alert(result);
                    ...
                    $.each(objfirst, function(i, item) {
                        ...
                        $('#tableorderview > tbody:last').append('<tr><td>' + objfirst[i].productname + '</td><td class="d-none">' + objfirst[i].productid + '</td><td class="text-center">' + objfirst[i].newqty + '</td><td class="">' + objfirst[i].freeproduct + '</td><td class="d-none">' + objfirst[i].freeproductid + '</td><td class="text-center">' + objfirst[i].freeqty + '</td><td class="text-right total">' + objfirst[i].total + '</td></tr>');
                    });
        ...
        $('#orderdate').change(function(){$('#repname').focus();});
        $("#formsubmit").click(function() {
            if (!$("#createorderform")[0].checkValidity()) {
                ...
                $('#tableorder > tbody:last').append('<tr class="pointer"><td>' + product + '</td><td class="d-none">' + productID + '</td><td class="d-none">' + unitprice + '</td><td class="d-none">' + saleprice + '</td><td class="text-center">' + newqty + '</td><td class="">' + freeproductname + '</td><td class="d-none">' + freeproductid + '</td><td class="text-center">' + freeqty + '</td><td class="text-center">' + totalqty + '</td><td class="text-right">' + addCommas(saleprice) + '</td><td class="total d-none">' + total + '</td><td class="text-right">' + showtotal + '</td></tr>');
