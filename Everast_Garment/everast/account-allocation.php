                                                ...
                                                <table class="table table-sm table-bordered table-striped" id="unallocatedtable">
                                                    <thead>
                                                        <tr>
                                                            <th>Account</th>
                                                            <th>Account Name</th>
                                                            <th class="d-none">CompanyID</th>
                                                            <th class="d-none">CompanybranchID</th>
...
<script>
    $(document).ready(function() {
        ...
        $('#mainclass').change(function(){
            if (!$("#unallocated")[0].checkValidity()) {
                ...
                getaccounts(mainclass, mainaccount, company, companybranch);
                getallocatedaccounts(mainclass, mainaccount, company, companybranch)
            }
        });
    ...
    function getaccounts(mainclass, mainaccount, company, companybranch){
        if(mainclass!='' | mainaccount!=''){
            $.ajax({
                ...
                url: 'getprocess/getunalocatedaccount.php',
                success: function(result) { //alert(result);
        ...
        $('#allocatedaccountbtn').click(function(){
            ...
            if(jsonObj==''){
                ...
                $.ajax({
                    ...
                    url: 'process/accountallocationprocess.php',
                    success: function(result) { //alert(result);
                        action(result);
                        location.reload();
                    }
    ...
    function getallocatedaccounts(mainclass, mainaccount, company, companybranch){
        if(mainclass!='' | mainaccount!=''){
            $.ajax({
                type: "POST",
                data: {
                ...
                url: 'getprocess/getalocatedaccount.php',
                success: function(result) { //alert(result);
