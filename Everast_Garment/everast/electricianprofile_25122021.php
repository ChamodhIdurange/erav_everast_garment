                                ...
                                <div class="row">
                                    <div class="col-md-3 border-right">
                                        <div class="d-flex flex-column align-items-center text-center p-3 py-2"><img
                                                ...
                                                class="text-black-50"><?php  echo $resultpoints['contact'] ?></span><span>Star points - <?php echo $resultpoints['star_points']; ?> </span></div>
                                    </div>
                                    <div class="col-md-9 border-right">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link" id="gainedpoints-tab" data-toggle="tab" href="#gainedpoints"
                                                    role="tab" aria-controls="gainedpoints" aria-selected="false">Gained Star Points</a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link" id="offers-tab" data-toggle="tab" href="#offers"
                                                    role="tab" aria-controls="offers" aria-selected="false">Recived Offers</a>
                                            </li>
                                                            ...
                                                            <div class="scrollbar pb-3" id="style-2">
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td><?php echo $row['idtbl_contact_details'] ?></td>
                                                            ...
                                                            <div class="scrollbar pb-3" id="style-2">
                                                                <table
                                                                    ...
                                                                    <?php if($resultElecBank->num_rows > 0) {while ($row = $resultElecBank-> fetch_assoc()) { ?>
                                                                        <tr>
                                                                            <td><?php echo $row['idtbl_bank_account_details'] ?></td>
    ...
    <div class="modal-dialog modal-dialog-centered modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form id="contactform" action="process/personalbankinfoprocess.php" enctype="multipart/form-data"
            ...
            if (r == true) {
                ...
                $.ajax({
                    ...
                    success: function (result) { //alert(result);
                        ...
                        $('#submitBtnContact').html('<i class="far fa-save"></i>&nbsp;Update');
