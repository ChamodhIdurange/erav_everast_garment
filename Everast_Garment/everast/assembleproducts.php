                                ...
                                <div class="row">
                                    <div class="col">
                                        <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right"
                                            id="btnAssemble"><i class="fas fa-plus"></i>&nbsp;Assemble Product</button>
                                    </div>
                                </div>
                                <hr>
...
<script>
    ...
    $(document).ready(function () {
                ...
                },
                {
                    ...
                    "render": function (data, type, full) {
                        ...
                        if (full['callstatus'] == 0 && full['status'] == 1) {
                            button +=
                                '<button class="btn btn-success btn-sm btncall mr-1" data-toggle="tooltip" data-placement="bottom" title="Call to customer" id="' +
                                full['idtbl_porder'] +
                                '"><i class="fas fa-phone"></i></button>';
                        } else if (full['status'] == 1) {
                            button +=
                                '<button class="btn btn-danger btn-sm mr-1" data-toggle="tooltip" data-placement="bottom" title="Call completed" ><i class="fas fa-phone"></i></button>';
                        }
        ...
        $('#modalassemble').on('hidden.bs.modal', function () {
            $('#orderdate').val('');
            $('#product').val('');
            $('#repname').val('');
            $('#area').val('');
