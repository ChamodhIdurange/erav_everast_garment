           ...
           // alert(recordID);
            ...
            $.ajax({
                ...
                success: function(result) { //alert(result);
                    ...
                    $('#divsubtotal').html('Rs. ' + addCommas(parseFloat(obj.subtotal).toFixed(2)));
                    $('#divdiscount').html('Rs. ' + addCommas(parseFloat(obj.disamount).toFixed(2)));
                    $('#divdiscountPO').html('Rs. ' + obj.po_amount);
                    $('#divtotal').html('Rs. ' + addCommas(parseFloat(obj.nettotal).toFixed(2)));
                        ...
                        success: function(data) {
                            ...
                            records.forEach(function(obj) {
                                ...
                                $('#tableorder > tbody:last').append('<tr class="pointer">' +
                                    ...
                                    '<td class="text-center">' + obj.freeqty + '</td>' +
                                    '<td class="text-center">' + totalqty + '</td>' +
                                    '<td class="text-right">' + addCommas(obj.saleprice) + '</td>' +
                                    '<td class="total d-none">' + obj.qty * obj.saleprice + '</td>' +
                                    '<td class="text-right">' + addCommas(obj.qty * obj.saleprice) + '</td>' +
                                    '</tr>');
                            });
