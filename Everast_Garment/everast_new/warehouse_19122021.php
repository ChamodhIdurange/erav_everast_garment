            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
                        <div class="form-group mb-1">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control dpd1a" placeholder="" name="orderdate" id="orderdate" value="" readonly>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-9 col-xl-9">
                        ...
                        <div class="row">
                            <div class="col-9 text-right"><h5 class="font-weight-600">Subtotal</h5></div>
                            <div class="col-3 text-right"><h5 class="font-weight-600" id="divsubtotal">Subtotal: Rs. 0.00</h5></div>
                            <div class="col-9 text-right"><h5 class="font-weight-600">Discount</h5></div>
                            <div class="col-3 text-right"><h5 class="font-weight-600" id="divdiscount">Rs. 0.00</h5></div>
                            <div class="col-9 text-right"><h1 class="font-weight-600">Nettotal</h1></div>
                            <div class="col-3 text-right"><h1 class="font-weight-600" id="divtotal">Rs. 0.00</h1></div>
                        ...
                        <div class="form-group mt-2">
                            <button type="button" id="btncreateorder" class="btn btn-outline-primary btn-sm fa-pull-right" <?php if($addcheck==0){echo 'disabled';} ?>><i class="fas fa-save"></i>&nbsp;Create Invoice</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        button+='<button class="btn btn-outline-success btn-sm mr-1" data-toggle="tooltip" data-placement="bottom" title="Accepted Order"><i class="fas fa-check"></i></button>';
                        button+='<button class="btn btn-outline-primary btn-sm mr-1 btninvoice" data-toggle="tooltip" data-placement="bottom" title="Create Invoice" id="'+full['idtbl_porder']+'"><i class="far fa-file-alt"></i></button>';
        ...
        $('#dataTable tbody').on('click', '.btninvoice', function() {
            ...
            $.ajax({
                ...
                success: function(result) { //alert(result);
                    ...
                    let htmlrep='';
                    htmlrep+='<option value="'+obj.idtbl_employee+'">'+obj.repname+'</option>'
                    $('#repname').empty().append(htmlrep);

                    let htmlarea='';
                    htmlarea+='<option value="'+obj.idtbl_area+'">'+obj.area+'</option>'
                    $('#area').empty().append(htmlarea);

                    let htmlcustomer='';
                    htmlcustomer+='<option value="'+obj.idtbl_customer+'">'+obj.cusname+'</option>'
                    ...
                    $.each(objfirst, function(i, item) {
                        ...
                        $('#invoicetable > tbody:last').append('<tr><td>' + objfirst[i].product + '</td><td class="d-none">' + objfirst[i].productid + '</td><td class="d-none">' + objfirst[i].unitprice + '</td><td class="d-none">' + objfirst[i].saleprice + '</td><td class="text-center editnewqty">' + objfirst[i].qty + '</td><td class="">' + objfirst[i].freeproduct + '</td><td class="d-none">' + objfirst[i].freeproductid + '</td><td class="text-center editfreeqty">' + objfirst[i].freeqty + '</td><td class="text-center">' + totqty + '</td><td class="text-right">' + addCommas(parseFloat(objfirst[i].saleprice).toFixed(2)) + '</td><td class="total d-none">' + itemtotal + '</td><td class="text-right">' + addCommas(itemtotal) + '</td></tr>');
                    });
        ...
        $('#invoicetable tbody').on('click', '.editfreeqty', function(e) {
            ...
            $('<input type="Text" class="form-control form-control-sm optionfreeqty">').val(val).appendTo($this);
