                        ...
                        <form id="createorderform" autocomplete="off">
                            ...
                            <div class="form-row mb-1">
                                <div class="col">
                                    ...
                                    <input type="text" id="customeraddress" name="customeraddress" class="form-control form-control-sm" readonly required>
                                </div>
                            </div>
                            <div class="form-row mb-1">
                                <div class="col">
                                    <label class="small font-weight-bold text-dark">Customer contact*</label>
                                    <input type="text" id="customercontact" name="customercontact" class="form-control form-control-sm" readonly required>
                                </div>
                            </div>
                            <div class="form-row mb-1">
                                <div class="col">
        ...
        $('#dataTable').DataTable( {
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        var button='';
                        button+='<button class="btn btn-outline-dark btn-sm btnview mr-1 " data-toggle="tooltip" data-placement="bottom" title="View PO Details" id="'+full['idtbl_porder']+'" name="'+full['confirmstatus']+'"><i class="far fa-eye"></i></button>';
                        if(full['status']==2){
                        ...
                        if(full['callstatus']==0 && full['status']==1){
                            button+='<button class="btn btn-success btn-sm btncall mr-1" data-toggle="tooltip" data-placement="bottom" title="Call to customer" id="'+full['idtbl_porder']+'"><i class="fas fa-phone"></i></button>';
                        }
                        else if(full['status']==1){
                            button+='<button class="btn btn-danger btn-sm mr-1" data-toggle="tooltip" data-placement="bottom" title="Call completed" ><i class="fas fa-phone"></i></button>';
                        }
                        ...
                        if(full['deliverystatus']==0 && full['status']==1){button+='<button class="btn btn-outline-danger btn-sm mr-1 btncancel" data-toggle="tooltip" data-placement="bottom" title="Cancel order" id="'+full['idtbl_porder']+'"><i class="fas fa-window-close"></i></button>';}
                        return button;
                    }
                }
            ]
            ...
            $.ajax({
                ...
                success: function(result) { //alert(result);
                    ...
                    $.each(objfirst, function(i, item) {
                        ...
                        $('#tableorderview > tbody:last').append('<tr><td>' + objfirst[i].productname + '</td><td class="d-none">' + objfirst[i].productid + '</td><td class="text-center editnewqty">' + objfirst[i].newqty + '</td><td class="">' + objfirst[i].freeproduct + '</td><td class="d-none">' + objfirst[i].freeproductid + '</td><td class="text-center">' + objfirst[i].freeqty + '</td><td class="text-right total">' + objfirst[i].total + '</td><td class="">' + objfirst[i].unitprice + '</td></tr>');
                    });
                    if(confirmstatus == 1){
                        $('#btnUpdate').html('<i class="far fa-save"></i>&nbsp;Already confirmed');
        ...
        function textremove(classname, row) {
            $('#tableorderview tbody').on('keyup', classname, function(e) {
                if (e.keyCode === 13) { 
                    ...
                    $('#tableorderview').find('tr').eq(rowID).find('td:eq(6)').text(totnew);
