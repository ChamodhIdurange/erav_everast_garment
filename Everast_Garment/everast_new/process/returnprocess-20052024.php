...
if($recordOption==1) {
    ...
    if($returntype==3 || $returntype==1 ) {
        ...
        if($returntype==1){
            $query="INSERT INTO `tbl_return`(`tbl_employee_idtbl_employee`, `returntype`, `returndate`, `status`, `updatedatetime`, `tbl_user_idtbl_user`, `tbl_customer_idtbl_customer`, `acceptance_status`, `total`) VALUES ('$asm', '$returntype','$today','1','$updatedatetime','$userID','$customer', '0', '$total')";
