...
$sqlreturncustomeraccepted="SELECT `e`.`name` as `asm`, `u`.`idtbl_return`, `u`.`returndate`, `u`.`total`, `ua`.`name` FROM `tbl_return` as `u` LEFT JOIN `tbl_customer` AS `ua` ON (`ua`.`idtbl_customer` = `u`.`tbl_customer_idtbl_customer`) JOIN `tbl_employee` AS `e` ON (`e`.`idtbl_employee` = `u`.`tbl_employee_idtbl_employee`) WHERE `u`.`acceptance_status` = '1' and `u`.`returntype` = '1' and `u`.`recieved_status` = '0'";
                ...
                <div class="card">
                    <div class="card-body p-0 p-2">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="qtycorrect-tab" data-toggle="tab" href="#qtycorrect"
                                    role="tab" aria-controls="qtycorrect" aria-selected="false">Quantity Correct</a>
                            </li>

                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="damage-tab" data-toggle="tab" href="#damage" role="tab"
                                    aria-controls="damage" aria-selected="false">Quantity Wrong</a>
                            </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="col-12">
                                            <div class="scrollbar pb-3" id="style-2">
                                                <table class="table table-bordered table-striped table-sm nowrap"
                                                    ...
                                                    <tbody>
                                                        <?php if($resultreturncustomeraccepted->num_rows > 0) {while ($row = $resultreturncustomeraccepted-> fetch_assoc()) { ?>
                                                        <tr>
                                        ...
                                        <div class="col-12">
                                            <div class="scrollbar pb-3" id="style-2">
                                                <table class="table table-bordered table-striped table-sm nowrap"
                                                    ...
                                                    <tbody>
                                                        <?php if($resultreturndeliverycompleted->num_rows > 0) {while ($row = $resultreturndeliverycompleted-> fetch_assoc()) { ?>
                                                        <tr>
                                                            ...
                                                            <td> <button class="btn btn-outline-primary btn-sm rounded btnView"
                                                                ...
                                                                <button
                                                                    ...
                                                                    class="btn btn-outline-success btn-sm" disabled><i
                                                                        ...
                                                                        <button class="btn btn-outline-secondary btn-sm rounded btnQuantity"
                                                                    id="<?php echo $row['idtbl_return']; ?>"><i
                            ...
                            <div class="tab-pane fade" id="qtycorrect" role="tabpanel"
                                aria-labelledby="qtycorrect-tab">
                                <div class="inputrow">
                                        ...
                                        <div class="col-12">
                                            <div class="scrollbar pb-3" id="style-2">
                                                <table class="table table-bordered table-striped table-sm nowrap"
                                                    ...
                                                    <tbody>
                                                        <?php if($resultqtycorrect->num_rows > 0) {while ($row = $resultqtycorrect-> fetch_assoc()) { ?>
                                                        <tr>
                                                            ...
                                                            <td> <button class="btn btn-outline-primary btn-sm rounded btnView"
                                                                ...
                                                                <button
                                                                    ...
                                                                    class="btn btn-outline-success btn-sm" disabled><i
                                                                        data-feather="truck" ></i></button>
                                                                        <button class="btn btn-outline-success btn-sm rounded btnQuantity"
                                                                    id="<?php echo $row['idtbl_return']; ?>"disabled><i
                                                                        class="fas fa-question"></i></button>
                                                                <button</td>
                                                        </tr>
                                                        <?php }} ?>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <table class="table table-bordered table-striped table-sm nowrap"
                                                    ...
                                                    <tbody>
                                                        <?php if($resultqtywrong->num_rows > 0) {while ($row = $resultqtywrong-> fetch_assoc()) { ?>
                                                        <tr>
